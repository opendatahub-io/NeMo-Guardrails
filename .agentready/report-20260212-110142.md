...
**Path**: `/Users/ddahlem/Documents/repos/trusty/opendatahub-io/NeMo-Guardrails`
**Branch**: `develop` | **Commit**: `3ec3e81d`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **56.5/100** 🥉 **Bronze** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
![T1](https://img.shields.io/badge/T1-Type_Annotations_37--100-red) **Type Annotations** ❌ 37/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 29.9% (Threshold: ≥80%)

**Evidence**:
- Typed functions: 979/3279
- Coverage: 29.9%
...
**Measured**: 16 huge, 29 large out of 580 (Threshold: <5% files >500 lines, 0 files >1000 lines)

**Evidence**:
- Found 16 files >1000 lines (2.8% of 580 files)
- Largest: docs/colang-2/examples/csl.py (1096 lines)
...
![T2](https://img.shields.io/badge/T2-Inline_Documentation_67--100-red) **Inline Documentation** ❌ 67/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 53.8% (Threshold: ≥80%)

**Evidence**:
- Documented items: 2074/3853
- Coverage: 53.8%
...
**Measured**: organization:100, cohesion:92, naming:0 (Threshold: ≥75 overall)

**Evidence**:
- Good directory organization (feature-based or flat)
- File cohesion: 45/569 files >500 lines
...
![T2](https://img.shields.io/badge/T2-Concise_Documentation_72--100-red) **Concise Documentation** ❌ 72/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 337 lines, 25 headings, 8 bullets (Threshold: <500 lines, structured format)

**Evidence**:
- README length: 337 lines (good)
...
- **Repository Snapshot**: 3ec3e81dbe655f54709011d3de8a6d5062d00e33
- **Assessment Duration**: 2.1s
